<?php include "header.php"; ?><br><br><br>
        ...
        <div class="row">
            <div class="col-md-12">
                <h2 class="text-center">PENDAFTARAN MAHASISWA</h2><br><br><br>
            <form action="proses-pendaftaran.php" method="post">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="pilihan_jurusan">
                        <option value="Ilmu Pengetahuan Alam">SOSHUM</option>
                        <option value="Ilmu Pengetahuan Sosial">SAINTEK</option>
                    </select>
                </div><br>
